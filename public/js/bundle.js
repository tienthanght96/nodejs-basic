...
/* eslint-disable */
var displayMap = function displayMap(locationsString) {
  var locations = locationsString && Array.isArray(JSON.parse(locationsString)) ? JSON.parse(locationsString) : [];
  mapboxgl.accessToken = 'pk.eyJ1IjoidGhhbmd0cmFuY29kZSIsImEiOiJjanl2ZTI4dmIwMWZxM21teG5pc3o0Y2EyIn0.9EW5KrDuVwgZxFHPm575Ig';
...
exports.alertMessage = exports.hideMessage = void 0;
...
var alertMessage = function alertMessage(type, msg) {
        ...
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (response.data.status === 'success') {
              (0, _alert.alertMessage)('success', 'Login success!');
          ...
          case 8:
            ...
            (0, _alert.alertMessage)('error', _context.t0.response.data.message);
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.prev = 0;
            _context2.next = 3;
            return _axios.default.post('http://localhost:3000/api/v1/users/logout');
          ...
          case 7:
            ...
            (0, _alert.alertMessage)('error', 'Can not logout. Try again!');
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            endpoint = type === 'password' ? 'http://localhost:3000/api/v1/users/update-password' : 'http://localhost:3000/api/v1/users/update-me';
            _context.next = 4;
          ...
          case 4:
            ...
            if (response.data.status === 'success') {
              (0, _alert.alertMessage)('success', "".concat(type.toUpperCase(), " updated successfully!"));
            }
...
var stripe = Stripe('pk_test_Ejq0VxgFHn0XQOlbAUDyYqu700CsJYMrU9');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 9:
            _context.prev = 9;
            _context.t0 = _context["catch"](0);
            (0, _alert.alertMessage)('error', 'Something went wrong');
...
var formLoginElement = document.querySelector('.form.form__login');
var btnLogoutElement = document.querySelector('.nav__el.nav__el--logout');
var mapElement = document.getElementById('map');
var formUserDataElement = document.querySelector('.form.form-user-data');
var formUserPasswordElement = document.querySelector('.form.form-user-password');
...
if (mapElement && mapElement.dataset.locations) {
  (0, _mapbox.displayMap)(mapElement.dataset.locations);
}

if (btnLogoutElement) {
  btnLogoutElement.addEventListener('click', _login.logout);
}

if (formUserDataElement) {
  formUserDataElement.addEventListener('submit', function (event) {
    event.preventDefault();
    ...
    (0, _updateSetting.updateUserSettings)(form, 'data');
  });
}

if (formUserPasswordElement) {
  formUserPasswordElement.addEventListener('submit',
  /*#__PURE__*/
  function () {
    var _ref = _asyncToGenerator(
    /*#__PURE__*/
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 7;
              return (0, _updateSetting.updateUserSettings)({
...
if (bookTourElement) {
  bookTourElement.addEventListener('click', function (event) {
